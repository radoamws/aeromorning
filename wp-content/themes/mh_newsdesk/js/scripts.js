...
jQuery(document).ready(function($){
	...
	jQuery(function(){
		jQuery('.main-nav').slicknav({ prependTo:'.header-menu', duration: 500, allowParentLinks: true });
...
jQuery(function ($) {
    ...
    $(document).on('click', '.slicknav_btn', function () {
        ...
        $(this).attr(
            'aria-expanded',
            $(this).hasClass('slicknav_open') ? 'true' : 'false'
        );

    });

});
		jQuery(document).on("click", "#n2-ss-4 .n2-ss-slide", function(){
			console.log("banniere");
			var liens = jQuery(this).attr("data-href");
			var l = liens.split("/");
			var name = l[2].replace("www.", "").split(".")[0]; 
			...
			jQuery.ajax({
				...
				data: {"action": "save", "name": name, "langue": langue},
		...
		jQuery(document).on("click", "#n2-ss-5-align .n2-ss-slide", function(){
			console.log("slider");
			var liens = jQuery(this).attr("data-href");
			var l = liens.split("/");
			var name = l[2].replace("www.", "").split(".")[0]; 
			...
			jQuery.ajax({
				...
				data: {"action": "save2", "name": name, "langue": langue},
		...
		jQuery(document).on("click", ".mh-sidebar .widget_media_image a", function(){
			console.log("widget");
			var liens = jQuery(this).attr("href");
			var l = liens.split("/");
			var name = l[2].replace("www.", "").split(".")[0]; 
			var langue = jQuery("html").attr("lang");
			console.log(langue);
			...
			jQuery.ajax({
				...
				data: {"action": "save3", "name": name, "langue": langue},
