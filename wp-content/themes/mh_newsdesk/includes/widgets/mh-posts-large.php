...
class mh_newsdesk_posts_large extends WP_Widget {
    function __construct() {
		parent::__construct(
			...
			array('classname' => 'mh_newsdesk_posts_large', 'description' => esc_html__('Display posts with large images on front page for use in "Home 1" or "Home 4" widget areas.', 'mh-newsdesk'))
		);
	}
