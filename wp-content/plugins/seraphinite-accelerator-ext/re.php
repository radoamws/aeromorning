...
if( isset( $aOpts[ 't' ] ) )
{
	...
	if( !function_exists( 'proc_open' ) || !function_exists( 'proc_close' ) || !function_exists( 'proc_get_status' ) )
...

{
	...
	$_SERVER[ 'SERVER_SOFTWARE' ] = ( strlen( $aOpts[ 'soft' ] ) ? rawurldecode( _seraph_accel_re_Rtn::ExecUnMaskUrlArg( $aOpts[ 'soft' ] ) ) : 'Generic' );
	if( strpos( $_SERVER[ 'SERVER_SOFTWARE' ], 'Emulator' ) === false )
		$_SERVER[ 'SERVER_SOFTWARE' ] .= ' (Seraph Accel Request Emulator 2.29.11)';
...
if( !isset( $_SERVER[ 'HTTP_USER_AGENT' ] ) )
	$_SERVER[ 'HTTP_USER_AGENT' ] = 'Seraph Accel Request Emulator 2.29.11';
