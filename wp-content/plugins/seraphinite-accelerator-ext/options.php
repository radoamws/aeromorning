...
function _SettingsPage()
{
	...
	wp_register_script( Plugin::ScriptId( 'Admin' ), add_query_arg( Plugin::GetFileUrlPackageParams(), Plugin::FileUrl( 'Admin.js', __FILE__ ) ), array_merge( array( 'jquery' ), Plugin::CmnScriptId( array( 'Cmn', 'Gen', 'Ui', 'Net' ) ) ), '2.29.11' );
...

	{
		...
		if( Gen::GetArrField( PluginRmtCfg::Get(), 'Prms.HostingBannerShow-Full' ) )
					...
					$o .= ( Ui::SettBlock_Item_Begin( esc_html_x( 'Lbl', 'admin.Settings_Cache_Revalidate_UpdGlobs', 'seraphinite-accelerator' ) . Ui::AdminBtnsBlock( array( array( 'type' => Ui::AdminBtn_Help, 'href' => Plugin::RmtCfgFld_GetLoc( $rmtCfg, 'Help.Settings_Cache_Revalidate_UpdGlobs' ) ) ), Ui::AdminHelpBtnModeText ), array( 'style' => array( 'display' => $adminMsModes[ 'local' ] ? null : 'none' ) ) ) );
					{
						...
						$o .= ( Ui::SettBlock_ItemSubTbl_Begin( array( 'class' => 'blck ctlMaxSizeX', 'style' => array( 'display' => 'none' ) ) ) );
						{
							...
							$o .= ( Ui::TagOpen( 'tr' ) );
							{
								$o .= ( Ui::TagOpen( 'td' ) );
								{
									$fldId = 'cache/updGlobs/tpl/enable';
									$o .= ( Ui::CheckBox( esc_html_x( 'WpTplChk', 'admin.Settings_Cache_Revalidate_UpdGlobs', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, null, '/' ), true ) );
								}
								$o .= ( Ui::TagClose( 'td' ) );
							}
							$o .= ( Ui::TagClose( 'tr' ) );
...
function _SettingsPage_Server( $callbacks_args, $box )
{
				...
				$o .= ( Ui::SettBlock_Begin() );
				{
					...
					{
						$o .= ( Ui::SettBlock_ItemSubTbl_Begin( array( 'class' => 'std ctlMaxSizeX blck' ) ) );
						{
							$o .= ( Ui::TagOpen( 'tr' ) );
							{
								$o .= ( Ui::TagOpen( 'td' ) );
							...
							$o .= ( Ui::TagOpen( 'tr' ) );
							{
								$o .= ( Ui::TagOpen( 'td' ) );
								{
									$fldId = 'cache/cloudflare/auth';
									$o .= ( Ui::Label( sprintf( esc_html_x( 'Auth_%1$s', 'admin.Settings_Cache_Srv_CloudFlare', 'seraphinite-accelerator' ), Ui::ComboBox(
										'seraph_accel/' . $fldId,
										array(
											'key'		=> esc_html_x( 'Key', 'admin.Settings_Cache_Srv_CloudFlare_Auth', 'seraphinite-accelerator' ),
											'token'		=> esc_html_x( 'Token', 'admin.Settings_Cache_Srv_CloudFlare_Auth', 'seraphinite-accelerator' ),
										),
										Gen::GetArrField( $sett, $fldId, '', '/' ), true, array( 'class' => 'ctlMaxSizeX', 'data-oninit' => 'jQuery(this).change()', 'onchange' => 'seraph_accel.Ui.ComboShowDependedItems( this, jQuery( this.parentNode ).closest( ".blck" ).first().get( 0 ) )' ) ) ) ) );
								}
								$o .= ( Ui::TagClose( 'td' ) );
							}
							$o .= ( Ui::TagClose( 'tr' ) );

							$o .= ( Ui::TagOpen( 'tr', array( 'class' => 'ns-key', 'style' => array( 'display' => 'none' ) ) ) );
							{
								$o .= ( Ui::TagOpen( 'td' ) );
								{
									$fldId = 'cache/cloudflare/email';
									$o .= ( Ui::Label( sprintf( esc_html_x( 'Email_%1$s', 'admin.Settings_Cache_Srv_CloudFlare', 'seraphinite-accelerator' ), Ui::InputBox( 'email', 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, '', '/' ), array( 'style' => array( 'width' => '100%' ) ), true ) ), false, array( 'class' => 'ctlMaxSizeX' ) ) );
								}
								$o .= ( Ui::TagClose( 'td' ) );
							}
							$o .= ( Ui::TagClose( 'tr' ) );
							...
							$o .= ( Ui::TagOpen( 'tr', array( 'class' => 'ns-key', 'style' => array( 'display' => 'none' ) ) ) );
							{
								$o .= ( Ui::TagOpen( 'td' ) );
								{
									$fldId = 'cache/cloudflare/apiKey';
									$o .= ( Ui::Label( sprintf( esc_html_x( 'ApiKey_%1$s', 'admin.Settings_Cache_Srv_CloudFlare', 'seraphinite-accelerator' ), Ui::InputBox( 'password', 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, '', '/' ), array( 'style' => array( 'width' => '100%' ) ), true ) ), false, array( 'class' => 'ctlMaxSizeX' ) ) );
								}
								$o .= ( Ui::TagClose( 'td' ) );
							}
							$o .= ( Ui::TagClose( 'tr' ) );

							$o .= ( Ui::TagOpen( 'tr', array( 'class' => 'ns-token', 'style' => array( 'display' => 'none' ) ) ) );
							{
								$o .= ( Ui::TagOpen( 'td' ) );
								{
						...
						$o .= ( Ui::SettBlock_ItemSubTbl_Begin( array( 'class' => 'blck ctlMaxSizeX', 'style' => array( 'display' => 'none' ) ) ) );
						{
							$o .= Ui::TableCells(
								array(
									...
									function( $sett )
									{
										$fldId = 'contPr/rc/chbsBkngFrm';
										return( Ui::CheckBox( esc_html_x( 'ChbsBkngFrmChk', 'admin.Settings_Html_RandCorr', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
									},

									function( $sett )
									{
										$fldId = 'contPr/rc/jegElmntr';
										return( Ui::CheckBox( esc_html_x( 'JegElmntrChk', 'admin.Settings_Html_RandCorr', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
									},

									function( $sett )
									{
										$fldId = 'contPr/rc/divi';
										return( Ui::CheckBox( esc_html_x( 'DiviChk', 'admin.Settings_Html_RandCorr', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
									},

									function( $sett )
									{
										$fldId = 'contPr/rc/pys';
										return( Ui::CheckBox( esc_html_x( 'PysChk', 'admin.Settings_Html_RandCorr', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
									},
								)
							, $sett, 3 );
						}
...
function _SettingsPage_Frames( $callbacks_args, $box )
{
	...
	$o .= ( Ui::SettBlock_Begin() );
	{
		...
		{
			$o .= ( Ui::ToggleButton( '.blck', array( 'style' => array( 'min-width' => '7em' ) ), array( 'class' => 'ctlSpaceVAfter' ) ) );
			$o .= ( Ui::TagOpen( 'div', array( 'class' => 'blck ctlMaxSizeX', 'style' => array( 'display' => 'none' ) ) ) );
			...
			$o .= ( Ui::SettBlock_ItemSubTbl_Begin( array( 'class' => 'ctlMaxSizeX' ) ) );
			{
				$o .= Ui::TableCells(
					array(
						...
						function( $sett )
						{
							$fldId = 'contPr/cp/elmntrRspnsv';
							return( Ui::CheckBox( esc_html_x( 'ElmntrRspnsvChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},
						...
						function( $sett )
						{
							$fldId = 'contPr/cp/elmntrStckHdr';
							return( Ui::CheckBox( esc_html_x( 'ElmntrStckHdrChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},
						...
						function( $sett )
						{
							$fldId = 'contPr/cp/wooNasaPrdGall';
							return( Ui::CheckBox( esc_html_x( 'WooNasaPrdGallChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},

						function( $sett )
						{
							$fldId = 'contPr/cp/wooPrdGallSld';
							return( Ui::CheckBox( esc_html_x( 'WooPrdGallSldChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},
						...
						function( $sett )
						{
							$fldId = 'contPr/cp/diviVidBox2';
							return( Ui::CheckBox( esc_html_x( 'DiviVidBox2Chk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},
						...
						function( $sett )
						{
							$fldId = 'contPr/cp/diviCntdwnTmr';
							return( Ui::CheckBox( esc_html_x( 'DiviCntdwnTmrChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},
						...
						function( $sett )
						{
							$fldId = 'contPr/cp/vhcThCarFldGall';
							return( Ui::CheckBox( esc_html_x( 'VhcThCarFldGallChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},

						function( $sett )
						{
							$fldId = 'contPr/cp/bdeSwpr';
							return( Ui::CheckBox( esc_html_x( 'BdeSwprChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},

						function( $sett )
						{
							$fldId = 'contPr/cp/bdeTabs';
							return( Ui::CheckBox( esc_html_x( 'BdeTabsChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},

						function( $sett )
						{
							$fldId = 'contPr/cp/btCntSld';
							return( Ui::CheckBox( esc_html_x( 'BtCntSldChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},

						function( $sett )
						{
							$fldId = 'contPr/cp/btMenu';
							return( Ui::CheckBox( esc_html_x( 'BtMenuChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},

						function( $sett )
						{
							$fldId = 'contPr/cp/wcs';
							return( Ui::CheckBox( esc_html_x( 'WcsChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},

						function( $sett )
						{
							$fldId = 'contPr/cp/tpgbAni';
							return( Ui::CheckBox( esc_html_x( 'TpgbAniChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
						},
					)
				, $sett, 3 );
			}
			...
			$o .= ( Ui::TagOpen( 'div', array( 'class' => array( 'ctlSpaceVBeforeLg' ) ) ) );
			{
				$fldId = 'contPr/cp/slckGen';

				$o .= Ui::CheckBox( esc_html_x( 'SlckGenChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true );

				$o .= ( Ui::ToggleButton( '.blck', array( 'style' => array( 'min-width' => '7em' ) ), array( 'class' => 'ctlSpaceVAfter' ) ) );
				$o .= ( Ui::TagOpen( 'div', array( 'class' => 'blck', 'style' => array( 'display' => 'none' ) ) ) );
				{
					$fldId = 'contPr/cp/slckGen_a';

					$items = Gen::GetArrField( $sett, $fldId, array(), '/' );
					foreach( $items as $i => $ai )
					{
						$bps = array();
						foreach( $ai[ 'bps' ] as $dim => $aiR )
							$bps[] = array_merge( array( 'maxWidth' => $dim ), $aiR );
						$ai[ 'bps' ] = $bps;
					...
					$o .= ( Ui::ItemsList( $itemsListPrms, $items, 'seraph_accel/' . $fldId,
						function( $cbArgs, $idItems, $items, $itemKey, $item )
						{
							...
							$o .= ( Ui::SettBlock_ItemSubTbl_Begin( array( 'class' => 'ctlMaxSizeX' ) ) );
							{
								$o .= ( Ui::TagOpen( 'tr' ) . Ui::TagOpen( 'td' ) );
								{
									$o .= ( Ui::SettBlock_ItemSubTbl_Begin( array( 'class' => array( 'std', 'ctlMaxSizeX ctlSpaceVAfter' ) ) ) . Ui::TagOpen( 'tr' ) );
									{
										...
										{
											$fldId = 'selCss';
											$o .= ( Ui::Tag( 'td', Ui::TextBox( $idItems . '/' . $itemKey . '/' . $fldId, Gen::GetArrField( $item, $fldId, '', '/' ), array( 'class' => 'ctlMaxSizeX', 'placeholder' => _x( 'SelCssPhlr', 'admin.Settings_Frames_ContParts_SlckGen_Item', 'seraphinite-accelerator' ) ), true ) ) );
										}
									}
									$o .= ( Ui::TagClose( 'tr' ) . Ui::SettBlock_ItemSubTbl_End() );
								}
								...
								$o .= ( Ui::TagOpen( 'tr' ) . Ui::TagOpen( 'td' ) );
								{
									...
									$fldId2 = 'nextArrow';
									$fldId3 = 'customPaging';
									$o .= ( sprintf( esc_html_x( 'TplsLbl_%1$s%2$s%3$s', 'admin.Settings_Frames_ContParts_SlckGen_Item', 'seraphinite-accelerator' ),
										Ui::TextBox( $idItems . '/' . $itemKey . '/' . $fldId1, Gen::GetArrField( $item, $fldId1, '', '/' ), array( 'masked' => true, 'class' => 'inline ctlSpaceVBefore', 'style' => array( 'width' => '20em' ), 'placeholder' => '<button class="slick-prev" aria-label="Previous" type="button">Previous</button>' ), true ),
										Ui::TextBox( $idItems . '/' . $itemKey . '/' . $fldId2, Gen::GetArrField( $item, $fldId2, '', '/' ), array( 'masked' => true, 'class' => 'inline ctlSpaceVBefore', 'style' => array( 'width' => '20em' ), 'placeholder' => '<button class="slick-next" aria-label="Next" type="button">Next</button>' ), true ),
										Ui::TextBox( $idItems . '/' . $itemKey . '/' . $fldId3, Gen::GetArrField( $item, $fldId3, '', '/' ), array( 'masked' => true, 'class' => 'inline ctlSpaceVBefore', 'style' => array( 'width' => '20em' ), 'placeholder' => '<li><button type="button">{{SLIDE_NUMBER}}</button></li>' ), true ),
									) );
								}
								$o .= ( Ui::TagClose( 'td' ) . Ui::TagClose( 'tr' ) );
								...
								$o .= ( Ui::TagOpen( 'tr' ) . Ui::TagOpen( 'td', array( 'class' => 'blck' ) ) );
								{
									...
									$itemsListPrmsSub = array( 'editorAreaCssPath' => '.blck', 'sortable' => true );
									$o .= ( Ui::ItemsList( $itemsListPrmsSub, Gen::GetArrField( $item, $fldId, array( array() ), '/' ), $idItems . '/' . $itemKey . '/' . $fldId,
										function( $cbArgs, $idItems, $items, $itemKey, $item )
										{
											extract( $cbArgs );
											...
											$o .= ( Ui::SettBlock_ItemSubTbl_Begin( array( 'class' => 'ctlMaxSizeX' ) ) . Ui::TagOpen( 'tr' ) );
											{
												$o .= ( Ui::TagOpen( 'td' ) );
												{
													$o .= ( Ui::SettBlock_ItemSubTbl_Begin( array( 'class' => 'ctlMaxSizeX' ) ) );
													{
														...
														{
															$fldId = 'maxWidth';
															$o .= sprintf( esc_html_x( 'MinMaxWidth_%1$s', 'admin.Settings_Frames_ContParts_SlckGen_Item', 'seraphinite-accelerator' ), Ui::NumberBox( $idItems . '/' . $itemKey . '/' . $fldId, ( $v = Gen::GetArrField( $item, $fldId, null, '/' ) ) ? $v : '', array( 'style' => array( 'width' => '8em' ), 'placeholder' => esc_html_x( 'MaxWidthInf', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ) ), true ) );
														}
														$o .= ( Ui::TagClose( 'td' ) . Ui::TagClose( 'tr' ) );
														...
														{
															$fldId = 'arrows';
															$o .= ( Ui::CheckBox( esc_html_x( 'ArrowsChk', 'admin.Settings_Frames_ContParts_SlckGen_Item', 'seraphinite-accelerator' ), $idItems . '/' . $itemKey . '/' . $fldId, Gen::GetArrField( $item, $fldId, true, '/' ), true, array( 'class' => 'ctlSpaceAfter' ) ) );

															$fldId = 'dots';
															$o .= ( Ui::CheckBox( esc_html_x( 'DotsChk', 'admin.Settings_Frames_ContParts_SlckGen_Item', 'seraphinite-accelerator' ), $idItems . '/' . $itemKey . '/' . $fldId, Gen::GetArrField( $item, $fldId, false, '/' ), true, array( 'class' => 'ctlSpaceAfter' ) ) );

															$fldId = 'infinite';
															$o .= ( Ui::CheckBox( esc_html_x( 'InfiniteChk', 'admin.Settings_Frames_ContParts_SlckGen_Item', 'seraphinite-accelerator' ), $idItems . '/' . $itemKey . '/' . $fldId, Gen::GetArrField( $item, $fldId, true, '/' ), true, array( 'class' => 'ctlSpaceAfter' ) ) );

															$fldId = 'centerMode';
															$o .= ( Ui::CheckBox( esc_html_x( 'CenterModeChk', 'admin.Settings_Frames_ContParts_SlckGen_Item', 'seraphinite-accelerator' ), $idItems . '/' . $itemKey . '/' . $fldId, Gen::GetArrField( $item, $fldId, false, '/' ), true, array( 'class' => 'ctlSpaceAfter' ) ) );

															$fldId = 'vertical';
															$o .= ( Ui::CheckBox( esc_html_x( 'VerticalChk', 'admin.Settings_Frames_ContParts_SlckGen_Item', 'seraphinite-accelerator' ), $idItems . '/' . $itemKey . '/' . $fldId, Gen::GetArrField( $item, $fldId, false, '/' ), true, array( 'class' => 'ctlSpaceAfter' ) ) );
														}
														$o .= ( Ui::TagClose( 'td' ) . Ui::TagClose( 'tr' ) );
														...
														{
															$fldId = 'slidesToShow';
															$o .= sprintf( esc_html_x( 'SlidesToShow_%1$s', 'admin.Settings_Frames_ContParts_SlckGen_Item', 'seraphinite-accelerator' ), Ui::NumberBox( $idItems . '/' . $itemKey . '/' . $fldId, Gen::GetArrField( $item, $fldId, 1, '/' ), array( 'style' => array( 'width' => '4em' ) ), true ) );
														}
														$o .= ( Ui::TagClose( 'td' ) . Ui::TagClose( 'tr' ) );

														$o .= ( Ui::TagOpen( 'tr' ) . Ui::TagOpen( 'td' ) );
														{
															$fldId = 'slidesToScroll';
															$o .= sprintf( esc_html_x( 'SlidesToScroll_%1$s', 'admin.Settings_Frames_ContParts_SlckGen_Item', 'seraphinite-accelerator' ), Ui::NumberBox( $idItems . '/' . $itemKey . '/' . $fldId, Gen::GetArrField( $item, $fldId, 1, '/' ), array( 'style' => array( 'width' => '4em' ) ), true ) );
														}
														$o .= ( Ui::TagClose( 'td' ) . Ui::TagClose( 'tr' ) );
												...
												$o .= ( Ui::TagOpen( 'td', array( 'class' => 'ctlMinSizeX' ) ) );
												{
													$o .= ( Ui::Tag( 'div', Ui::ItemsList_ItemOperateBtns( $itemsListPrmsSub, array( 'class' => 'ctlSpaceVAfterSm' ) ) ) );
												}
												$o .= ( Ui::TagClose( 'td' ) );
											}
											$o .= ( Ui::TagClose( 'tr' ) . Ui::SettBlock_ItemSubTbl_End() );

											$o .= ( Ui::SepLine( 'div', array( 'class' => 'ctlSpaceVBefore ctlSpaceVAfter' ) ) );
										...
										array( 'itemsListPrmsSub' => $itemsListPrmsSub ), array( 'class' => 'ctlMaxSizeX' )
									) );

									$o .= ( Ui::Tag( 'div', Ui::ItemsList_OperateBtns( $itemsListPrmsSub, array( 'class' => 'ctlSpaceBefore' ) ), array( 'class' => 'ctlAlignRight' ) ) );
								}
								$o .= ( Ui::TagClose( 'td' ) . Ui::TagClose( 'tr' ) );
							}
							$o .= ( Ui::SettBlock_ItemSubTbl_End() );
							...
							$o .= ( Ui::SepLine( 'div', array( 'class' => 'ctlSpaceVAfter' ) ) );
					...
					$o .= ( Ui::Tag( 'div', Ui::ItemsList_OperateBtns( $itemsListPrms, array( 'class' => 'ctlSpaceAfter', 'style' => array( 'margin-left' => 0 ) ) ), array( 'class' => 'ctlSpaceVBefore1' ) ) );
				}
				$o .= ( Ui::TagClose( 'div' ) );
			}
			$o .= ( Ui::TagClose( 'div' ) );
			...
			$o .= ( Ui::TagOpen( 'div', array( 'class' => array( 'ctlSpaceVBeforeLg' ) ) ) );
			{
				$fldId = 'contPr/cp/swprGen';

				$o .= Ui::CheckBox( esc_html_x( 'SwprGenChk', 'admin.Settings_Frames_ContParts', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true );

				$o .= ( Ui::ToggleButton( '.blck', array( 'style' => array( 'min-width' => '7em' ) ), array( 'class' => 'ctlSpaceVAfter' ) ) );
				$o .= ( Ui::TagOpen( 'div', array( 'class' => 'blck', 'style' => array( 'display' => 'none' ) ) ) );
				{
					$fldId = 'contPr/cp/swprGen_a';
					$items = Gen::GetArrField( $sett, $fldId, array(), '/' );
					...
					$o .= ( Ui::ItemsList( $itemsListPrms, $items, 'seraph_accel/' . $fldId,
						function( $cbArgs, $idItems, $items, $itemKey, $item )
						{
							...
							$o .= ( Ui::SettBlock_ItemSubTbl_Begin( array( 'class' => 'ctlMaxSizeX' ) ) );
							{
								...
								$o .= ( Ui::TagOpen( 'tr' ) . Ui::TagOpen( 'td' ) );
								{
									$fldId = 'pagination/enable';
									$fldId1 = 'pagination/type';
									$fldId2 = 'pagination/clickable';
									$fldIdL = 'pagination/selCss';
									$o .= ( Ui::CheckBox( sprintf( esc_html_x( 'PaginationChk_%1$s%2$s%3$s', 'admin.Settings_Frames_ContParts_SwprGen_Item', 'seraphinite-accelerator' ),
										Ui::ComboBox(
											$idItems . '/' . $itemKey . '/' . $fldId1,
											array(
												'bullets'			=> esc_html_x( 'PagBullets', 'admin.Settings_Frames_ContParts_SwprGen_Item', 'seraphinite-accelerator' ),
												'progressbar'		=> esc_html_x( 'PagProgressbar', 'admin.Settings_Frames_ContParts_SwprGen_Item', 'seraphinite-accelerator' ),
											),
											Gen::GetArrField( $item, $fldId1, 'bullets', '/' ), true, array( 'class' => 'inline' ) ),
										Ui::ComboBox(
											$idItems . '/' . $itemKey . '/' . $fldId2,
											array(
												'1'			=> esc_html_x( 'PagClickable', 'admin.Settings_Frames_ContParts_SwprGen_Item', 'seraphinite-accelerator' ),
												''			=> esc_html_x( 'PagNonClickable', 'admin.Settings_Frames_ContParts_SwprGen_Item', 'seraphinite-accelerator' ),
											),
											Gen::GetArrField( $item, $fldId2, false, '/' ), true, array( 'class' => 'inline' ) ),
										Ui::TextBox( $idItems . '/' . $itemKey . '/' . $fldIdL, Gen::GetArrField( $item, $fldIdL, '', '/' ), array( 'style' => array( 'width' => '10em' ), 'placeholder' => _x( 'SelCssPhlr', 'admin.Settings_Frames_ContParts_SlckGen_Item', 'seraphinite-accelerator' ) ), true ),
									), $idItems . '/' . $itemKey . '/' . $fldId, Gen::GetArrField( $item, $fldId, false, '/' ), true, array( 'class' => 'ctlSpaceAfter' ) ) );
								}
								$o .= ( Ui::TagClose( 'td' ) . Ui::TagClose( 'tr' ) );
											...
											$o .= ( Ui::SettBlock_ItemSubTbl_Begin( array( 'class' => 'ctlMaxSizeX' ) ) . Ui::TagOpen( 'tr' ) );
											{
												$o .= ( Ui::TagOpen( 'td' ) );
												{
													$o .= ( Ui::SettBlock_ItemSubTbl_Begin( array( 'class' => 'ctlMaxSizeX' ) ) );
													{
														...
														{
															$fldId = 'spaceBetween';
															$o .= sprintf( esc_html_x( 'SpaceBetween_%1$s', 'admin.Settings_Frames_ContParts_SwprGen_Item', 'seraphinite-accelerator' ), Ui::NumberBox( $idItems . '/' . $itemKey . '/' . $fldId, Gen::GetArrField( $item, $fldId, 1, '/' ), array( 'min' => 0, 'style' => array( 'width' => '4em' ) ), true ) );
														}
														$o .= ( Ui::TagClose( 'td' ) . Ui::TagClose( 'tr' ) );
														...
														{
															$fldId = 'slidesPerView';
															$o .= sprintf( esc_html_x( 'SlidesPerView_%1$s', 'admin.Settings_Frames_ContParts_SwprGen_Item', 'seraphinite-accelerator' ), Ui::NumberBox( $idItems . '/' . $itemKey . '/' . $fldId, Gen::GetArrField( $item, $fldId, 1, '/' ), array( 'min' => 1, 'style' => array( 'width' => '4em' ) ), true ) );
														}
														$o .= ( Ui::TagClose( 'td' ) . Ui::TagClose( 'tr' ) );
													}
													$o .= ( Ui::SettBlock_ItemSubTbl_End() );
					...
					$o .= ( Ui::Tag( 'div', Ui::ItemsList_OperateBtns( $itemsListPrms, array( 'class' => 'ctlSpaceAfter' ) ), array( 'class' => 'ctlSpaceVBefore1' ) ) );
				}
				$o .= ( Ui::TagClose( 'div' ) );
			}
			$o .= ( Ui::TagClose( 'div' ) );
		...
		$o .= ( Ui::SettBlock_Item_Begin( esc_html_x( 'Lbl', 'admin.Settings_Scripts_Group', 'seraphinite-accelerator' ) . Ui::AdminBtnsBlock( array( array( 'type' => Ui::AdminBtn_Help, 'href' => Plugin::RmtCfgFld_GetLoc( $rmtCfg, 'Help.Settings_Scripts_Group' ) ) ), Ui::AdminHelpBtnModeText ) ) );
		{
			...
			$o .= ( Ui::SettBlock_ItemSubTbl_Begin( array( 'class' => 'blck ctlMaxSizeX', 'style' => array( 'display' => 'none' ) ) ) );
			{
				...
				$o .= ( Ui::TagOpen( 'tr' ) );
				{
					$o .= ( Ui::TagOpen( 'td' ) );
					{
						$fldId = 'contPr/js/groupTrC';
						$o .= ( Ui::CheckBox( esc_html_x( 'GroupTrCChk', 'admin.Settings_Scripts_Common', 'seraphinite-accelerator' ), 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, false, '/' ), true ) );
					}
					$o .= ( Ui::TagClose( 'td' ) );
				}
				$o .= ( Ui::TagClose( 'tr' ) );
			...
			$o .= ( Ui::SettBlock_ItemSubTbl_Begin(  array( 'style' => array( 'width' => '100%' ) ) ) );
			{
				...
				$o .= ( Ui::TagOpen( 'tr', array( 'style' => array( 'display' => $adminMsModes[ 'global' ] ? null : 'none' ) ) ) );
				{
					$o .= ( Ui::TagOpen( 'td' ) );
					{
						...
						{
							$fldId = 'asyncMgrMaxRunTime';
							$o .= ( Ui::Tag( 'p', Ui::Label( sprintf( esc_html_x( 'AsyncMgrMaxRunTime_%1$s', 'admin.Settings_Advanced_Common', 'seraphinite-accelerator' ), Ui::NumberBox( 'seraph_accel/' . $fldId, Gen::GetArrField( $sett, $fldId, 0, '/' ), array( 'min' => 0, 'placeholder' => '0', 'style' => array( 'width' => '4em' ) ), true ) ) )
								, array( 'class' => array( 'ns-', 'ns-loc', 'ns-re_r', 'ns-re', 'ns-ec' ), 'style' => array( 'padding-left' => '1.5em', 'display' => 'none' ) ) ) );
						}
...
function _OnSaveSettings( $args )
{
	...
	if( $adminMsModes[ 'global' ] )
	{
		...
		{ $fldId = 'asyncMgrMaxRunTime';					Gen::SetArrField( $sett, $fldId, @intval( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
	...
	if( $adminMsModes[ 'local' ] )
	{
		...
		{ $fldId = 'cache/cloudflare/auth';					Gen::SetArrField( $sett, $fldId, Gen::SanitizeTextData( trim( $args[ 'seraph_accel/' . $fldId ] ) ), '/' ); }
		{ $fldId = 'cache/cloudflare/email';				Gen::SetArrField( $sett, $fldId, trim( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{ $fldId = 'cache/cloudflare/apiKey';				Gen::SetArrField( $sett, $fldId, Gen::SanitizeTextData( trim( $args[ 'seraph_accel/' . $fldId ] ) ), '/' ); }
		...
		{ $fldId = 'cache/updGlobs/tpl/enable';				Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		...
		{ $fldId = 'contPr/cp/elmntrRspnsv';				Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		...
		{ $fldId = 'contPr/cp/elmntrStckHdr';				Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		...
		{ $fldId = 'contPr/cp/wooNasaPrdGall';				Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{ $fldId = 'contPr/cp/wooPrdGallSld';				Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{ $fldId = 'contPr/cp/xstrThSwpr';					Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{ $fldId = 'contPr/cp/vhcThCarFldGall';				Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{ $fldId = 'contPr/cp/bdeSwpr';						Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{ $fldId = 'contPr/cp/bdeTabs';						Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{ $fldId = 'contPr/cp/btCntSld';					Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{ $fldId = 'contPr/cp/btMenu';						Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		...
		{ $fldId = 'contPr/cp/diviVidBox2';					Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		...
		{ $fldId = 'contPr/cp/diviCntdwnTmr';				Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		...
		{ $fldId = 'contPr/cp/wcs';							Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{ $fldId = 'contPr/cp/tpgbAni';						Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }

		{ $fldId = 'contPr/cp/slckGen';						Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{
			$fldId = 'contPr/cp/slckGen_a';

			$items = Ui::ItemsList_GetSaveItems( 'seraph_accel/' . $fldId, '/', $args,
				function( $cbArgs, $idItems, $itemKey, $item, $args )
				{
					$item = array();

					{ $fldId = 'enable';					Gen::SetArrField( $item, $fldId, isset( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ), '/' ); }
					{ $fldId = 'selCss';					Gen::SetArrField( $item, $fldId, Wp::SanitizeText( @stripslashes( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ) ), '/' ); }
					{ $fldId = 'prevArrow';					Gen::SetArrField( $item, $fldId, Ui::UnmaskValue( @stripslashes( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ) ), '/' ); }
					{ $fldId = 'nextArrow';					Gen::SetArrField( $item, $fldId, Ui::UnmaskValue( @stripslashes( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ) ), '/' ); }
					{ $fldId = 'customPaging';				Gen::SetArrField( $item, $fldId, Ui::UnmaskValue( @stripslashes( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ) ), '/' ); }

					{
						...
						Gen::SetArrField( $item, $fldId, Ui::ItemsList_GetSaveItems( $idItems . '/' . $itemKey . '/' . $fldId, '/', $args,
							function( $cbArgs, $idItems, $itemKey, $item, $args )
							{
								...
								{ $fldId = 'maxWidth';					Gen::SetArrField( $item, $fldId, @intval( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ), '/' ); }
								{ $fldId = 'arrows';					Gen::SetArrField( $item, $fldId, isset( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ), '/' ); }
								{ $fldId = 'dots';						Gen::SetArrField( $item, $fldId, isset( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ), '/' ); }
								{ $fldId = 'infinite';					Gen::SetArrField( $item, $fldId, isset( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ), '/' ); }
								{ $fldId = 'centerMode';				Gen::SetArrField( $item, $fldId, isset( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ), '/' ); }
								{ $fldId = 'vertical';					Gen::SetArrField( $item, $fldId, isset( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ), '/' ); }
								{ $fldId = 'slidesToShow';				Gen::SetArrField( $item, $fldId, @intval( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ), '/' ); }
								{ $fldId = 'slidesToScroll';			Gen::SetArrField( $item, $fldId, @intval( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ), '/' ); }
								{ $fldId = 'prevArrow';					Gen::SetArrField( $item, $fldId, Ui::UnmaskValue( @stripslashes( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ) ), '/' ); }
								{ $fldId = 'nextArrow';					Gen::SetArrField( $item, $fldId, Ui::UnmaskValue( @stripslashes( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ) ), '/' ); }
								{ $fldId = 'customPaging';				Gen::SetArrField( $item, $fldId, Ui::UnmaskValue( @stripslashes( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ) ), '/' ); }
			...
			{
				$bps = array();
				foreach( $ai[ 'bps' ] as $aiR )
				{
					$dim = ( int )($aiR[ 'maxWidth' ]??0);
					unset( $aiR[ 'maxWidth' ] );
					$bps[ $dim ] = $aiR;
				}
				ksort( $bps );
			...
			Gen::SetArrField( $sett, $fldId, $items, '/' );
		}

		{ $fldId = 'contPr/cp/swprGen';						Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{
			$fldId = 'contPr/cp/swprGen_a';
			Gen::SetArrField( $sett, $fldId, Ui::ItemsList_GetSaveItems( 'seraph_accel/' . $fldId, '/', $args,
				function( $cbArgs, $idItems, $itemKey, $item, $args )
				{
					...
					{ $fldId = 'pagination/enable';			Gen::SetArrField( $item, $fldId, isset( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ), '/' ); }
...

					{
						...
						Gen::SetArrField( $item, $fldId, Ui::ItemsList_GetSaveItems( $idItems . '/' . $itemKey . '/' . $fldId, '/', $args,
							function( $cbArgs, $idItems, $itemKey, $item, $args )
							{
								...
								{ $fldId = 'minWidth';					Gen::SetArrField( $item, $fldId, ( $v = @intval( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ) ) ? $v : null, '/' ); }
								{ $fldId = 'maxWidth';					Gen::SetArrField( $item, $fldId, ( $v = @intval( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ) ) ? $v : null, '/' ); }
								{ $fldId = 'slidesPerView';				Gen::SetArrField( $item, $fldId, @intval( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ), '/' ); }
								{ $fldId = 'spaceBetween';				Gen::SetArrField( $item, $fldId, @intval( $args[ $idItems . '/' . $itemKey . '/' . $fldId ] ), '/' ); }
		...
		{ $fldId = 'contPr/js/groupTrC';					Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		...
		{ $fldId = 'contPr/rc/chbsBkngFrm';					Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{ $fldId = 'contPr/rc/jegElmntr';					Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{ $fldId = 'contPr/rc/divi';						Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
		{ $fldId = 'contPr/rc/pys';							Gen::SetArrField( $sett, $fldId, isset( $args[ 'seraph_accel/' . $fldId ] ), '/' ); }
